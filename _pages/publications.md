...
Welcome to my research page. Click any title to read the abstract or download papers, appendices, and replication files. You can also find my articles on my [Google Scholar profile](https://scholar.google.com/citations?hl=en&user=fL0DcbQAAAAJ).
 

## Articles, peer-reviewed

<details markdown="1">
<summary><strong>Undergraduate Political Science Curriculum Design in Five Democracies (forthcoming)</strong> - <em>Australian Journal of Political Science</em></summary>
...
[Published Version](https://doi.org/10.1177/00223433251360191) · [PDF](/files/JPR_2025.pdf) · [Appendix](/files/JPR_2025_appendix.pdf) · [Replication Materials](https://doi.org/10.7910/DVN/MXWSFA)
