---
title: "Why are some elections violent and others peaceful? After analyzing 65 studies, the answer is surprisingly thin"
author: Richard W. Frank
date: 2025-12-01
tags: [election violence, political violence, elections, meta-analysis, methods]
summary: My new article in the Journal of Peace Research pools 581 statistical models from 65 studies and finds that election-specific triggers like fraud and competitiveness predict violence more reliably than the structural staples of democracy and economic development.
---

Why do some elections turn violent while others are held off peacefully? This is a serious question, given that roughly one in five national elections sees some form of election-related violence, and that this violence can signal democratic backsliding and, at the extreme, tip a country toward civil war. Yet after more than a decade of quantitative research, the field still lacks an agreed-upon set of factors that reliably distinguish violent elections from peaceful ones. My new open-source [article]( https://doi.org/10.1177/00223433251360191) in the *Journal of Peace Research* asks a deceptively simple question of this fast-growing literature: across all the studies, which predictors hold up to scrutiny?

To answer this question, I conducted the first meta-analysis of the correlates of election violence. The sample includes 65 peer-reviewed articles published in English between 2010 and 2022 by 97 scholars, which together test more than 440 distinct predictors across 581 statistical models (204 at the national level and 377 at the subnational level). I coded each predictor across every model in which it appeared for whether it was statistically significant in the expected direction. I aggregated the results into a success rate and an average effect size for each variable. The approach borrows directly from earlier political science meta-analyses of [voter turnout]( https://doi.org/10.1016/j.electstud.2012.12.006)  and [party ideology]( https://doi.org/10.1023/A:1011889915999) .
...
![Figure 7](/images/figure_7.jpg){: width="50%" .align-center}
...
![Figure 8](/images/figure_8.jpg){: width="50%" .align-center}
...
If you are curious to know more, the article is open source and available [here](https://doi.org/10.1177/00223433251360191), and the replication data, codebook, and online appendix are posted at my [Dataverse]( https://doi.org/10.7910/DVN/MXWSFA). 
